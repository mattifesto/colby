...
(function () {
    ...
    /**
     * This function should be called when an order is successfully completed.
     * It empties the cart and takes care of other end of order operations.
     *
     * @return undefined
     */
    function
    SCCheckoutView_processOrderSuccessfullyCompleted(
    ) {
        SCShoppingCart.empty();

        let shippingAddressSpec = SCShippingAddress.fetchLocalSpec();

        SCShippingAddress.setSpecialInstructions(
            shippingAddressSpec,
            ""
        );
    ...
    window.SCCheckoutView = {
        ...
        payWithStripe: function () {
             ...
             */
            function
            payWithStripe_step3CardWasCharged(
                ajaxResponse
            ) {
                SCCheckoutView.paymentIsProcessing = false;
