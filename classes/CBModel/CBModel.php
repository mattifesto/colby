...
final class CBModel {
     ...
     *
     *      If a spec generates its own ID, it should be generated by the
     *      CBModel::toID() function and set before calling this function.
     *
     *      @NOTE
     ...
     *      model. One of the few requirements of a spec is that it have a set
     *      and supported className property. Otherwise the spec is just an
     *      object and null will be returned as the model.
     *
